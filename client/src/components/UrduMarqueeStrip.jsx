  ...
  return (
    <div className="bg-gradient-to-r from-[#081E48] via-[#0B3B82] to-[#081E48] text-white border-b border-blue-900/50 shadow-inner no-print overflow-hidden select-none py-1.5 px-3">
      <div className="max-w-7xl mx-auto flex items-center gap-2 sm:gap-3">
        ...
        {/* Urgent Ticker Pill */}
        <div className="shrink-0 flex items-center gap-1.5 bg-rose-600/90 text-white text-[10px] font-black uppercase tracking-wider px-2.5 py-0.5 rounded-full shadow-sm">
        ...
        <div className="flex-1 marquee-container overflow-hidden relative cursor-default" title="Hover to pause announcement">
          <div className="marquee-content font-urdu text-xs sm:text-[13px] font-bold text-amber-200 tracking-wide">
