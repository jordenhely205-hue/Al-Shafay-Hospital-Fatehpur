  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-xs p-4 overflow-y-auto" aria-modal="true">
      ...
      <div className="max-w-3xl max-h-[90vh] overflow-y-auto w-full mx-auto p-6 bg-white shadow-2xl rounded-2xl border border-slate-200 space-y-4 my-auto">
        ...
        <div id="printable-prescription" className="printable-a4-sheet a4-document-container printable-content bg-white text-xs flex flex-col justify-between">
          
          {/* Top Clinical Content Area */}
          ...
          {/* Bottom Pinned Footer & Signature Block */}
          <div className="mt-auto pt-3 space-y-2">
            
            {/* Signatures */}
            <div className="signature-bar flex justify-between items-end text-xs">
            ...
            <div className="text-[10px] text-gray-500 font-medium tracking-wide text-center pt-2 border-t border-gray-200">
